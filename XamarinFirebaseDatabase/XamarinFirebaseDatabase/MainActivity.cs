...
using Android.Views;
using XamarinFirebaseDatabase.Model;
...
namespace XamarinFirebaseDatabase
{
    [Activity(Label = "XamarinFirebaseDatabase", MainLauncher = true, Icon = "@drawable/icon", Theme = "@style/AppTheme")]
    public class MainActivity : AppCompatActivity
    {
        ...
        private const string FirebaseURL = "https://xamarinfcm-ce873.firebaseio.com/";
